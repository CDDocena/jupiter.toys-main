...
public class jupiterToys_Test extends Testbase{
	...
	public void testCase3(String dataItem1, String dataItem2, String dataItem3) throws IOException, ParseException {
		...
		try {
			...
			//3. Verify the sub total for each product is correct
			...
			reportLog.logResult("Step 3: Verify that each product's sub total = product price * quantity", true, "pass");
			...
			reportLog.logResult("Step 4: Verify the price for each product", true, "pass");
